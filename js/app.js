...
let serverIP = location.hostname,
    serverPort = (location.hash.match(/#port=([0-9]+)/) || [null, "3000"])[1],
    serverName = "Unknown",
    prefix = "",
    arenaClosed = !1;
    ...
    HSL2COLOR = function() {
        return function(l, e) {
            ...
            let t = document.createElement("canvas"),
                ...
                i = {},
                s, d, c, h, m;
            return t.width = t.height = 1, e && (n.fillStyle = e, n.fillRect(0, 0, 1, 1)), n.fillStyle = l, n.fillRect(0, 0, 1, 1), s = n.getImageData(0, 0, 1, 1).data, d = s[0], c = s[1], h = s[2], m = s[3], i = "#" + L(d.toString(16)) + L(c.toString(16)) + L(h.toString(16)) + L(m.toString(16)), i
        }
    }(),
    ...
    app = function(l) {
        ...
        function d(l, e, L) {
            let t = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : 0,
                a = N();
            return L += M.graphical.borderChunk, t ? (a *= 2, l > -S.screenWidth / a - L && l < S.screenWidth / a + L && e > -S.screenHeight / a - L && e < S.screenHeight / a + L) : l > -L && l < S.screenWidth / a + L && e > -L && e < S.screenHeight / a + L
        }
        ...
        function m() {
            switch (T.submitToLocalStorage("optScreenshotMode"), M.graphical.screenshotMode = document.getElementById("optScreenshotMode").checked, T.submitToLocalStorage("optNoPointy"), M.graphical.pointy = document.getElementById("optNoPointy").checked, T.submitToLocalStorage("optFancy"), M.graphical.fancyAnimations = !document.getElementById("optFancy").checked, T.submitToLocalStorage("optFourRows"), M.graphical.useFourRows = document.getElementById("optFourRows").checked, T.submitToLocalStorage("optMessages"), M.graphical.disableMessages = document.getElementById("optMessages").checked, T.submitToLocalStorage("optRoundUpg"), M.graphical.roundUpgrades = document.getElementById("optRoundUpg").checked, T.submitToLocalStorage("optOldPredict"), M.lag.oldPrediction = document.getElementById("optOldPredict").checked, T.submitToLocalStorage("optBorders"), document.getElementById("optBorders").value) {
                case "normal":
                    M.graphical.darkBorders = M.graphical.neon = M.graphical.noBorders = 0;
                    break;
                case "dark":
                    M.graphical.darkBorders = 1, M.graphical.noBorders = M.graphical.neon = 0;
                    break;
                case "borderless":
                    M.graphical.darkBorders = M.graphical.neon = 0, M.graphical.noBorders = 1;
                    break;
                case "glass":
                    M.graphical.darkBorders = M.graphical.noBorders = 0, M.graphical.neon = 1;
                    break;
                case "neon":
                    M.graphical.darkBorders = M.graphical.neon = 1, M.graphical.noBorders = 0;
            }
            T.submitToLocalStorage("optColors");
            let l = document.getElementById("optColors").value;
            I = I["" === l ? "normal" : l];
            let e = document.getElementById("playerNameInput"),
                L = document.getElementById("playerKeyInput");
            T.submitToLocalStorage("playerNameInput"), T.submitToLocalStorage("playerKeyInput"), S.playerName = J.name = e.value, S.playerKey = L.value.replace(/(<([^>]+)>)/ig, "").substring(0, 64), S.screenWidth = window.innerWidth, S.screenHeight = window.innerHeight, document.getElementById("startMenuWrapper").style.maxHeight = "0px", document.getElementById("gameAreaWrapper").style.opacity = 1, S.socket || (S.socket = Q(serverPort)), S.animLoopHandle || f(), window.canvas.socket = S.socket, _ = [], document.getElementById("gameCanvas").focus(), window.onbeforeunload = function() {
                return 1
            }, S.disableEnter = !0
        }

        function g(l, e) {
            c.fillStyle = l, c.globalAlpha = e, c.fillRect(0, 0, S.screenWidth, S.screenHeight), c.globalAlpha = 1
        }
        ...
        function b(l, e, L, t, a) {
            ...
            if (L.drawsHealth) {
                ...
                if (1 > t || 1 > r) {
                    let L = e + 1.1 * i + 15;
                    c.globalAlpha = a * a * n, E(l - o, l + o, L, 5 + M.graphical.barChunk, I.black), r && (c.globalAlpha = (.3 + .3 * r) * a * a * n, E(l - o, l - o + 2 * o * r, L, 9, I.teal), c.globalAlpha = a * a * n), E(l - o, l - o + 2 * o * t, L, 3, I.lgreen)
                }
            }
            if (L.id === Z.playerid) J.nameColor = L.nameColor;
            else if (L.nameplate) {
                null == L.render.textobjs && (L.render.textobjs = [ll(), ll()]);
                let t = L.nameColor;
                c.globalAlpha = a, L.name.includes("U\u2000S\u2000A") ? (L.render.textobjs[0].draw("U", l - 14, e - i - 30, 16, I.red, "center"), L.render.textobjs[0].draw("S", l, e - i - 30, 16, I.guiwhite, "center"), L.render.textobjs[0].draw("A", l + 14, e - i - 30, 16, I.blue, "center")) : L.name.includes("Trans Rights") ? (L.render.textobjs[0].draw("T", l - 50, e - i - 30, 16, "#5BCEF5", "center"), L.render.textobjs[0].draw("r", l - 41, e - i - 30, 16, "#F5A8B4", "center"), L.render.textobjs[0].draw("a", l - 32, e - i - 30, 16, "#FFFFFF", "center"), L.render.textobjs[0].draw("n", l - 23, e - i - 30, 16, "#F5A8B4", "center"), L.render.textobjs[0].draw("s", l - 14, e - i - 30, 16, "#5BCEF5", "center"), L.render.textobjs[0].draw("", l - 5, e - i - 30, 16, "#5BCEF5", "center"), L.render.textobjs[0].draw("R", l + 5, e - i - 30, 16, "#5BCEF5", "center"), L.render.textobjs[0].draw("i", l + 14, e - i - 30, 16, "#F5A8B4", "center"), L.render.textobjs[0].draw("g", l + 23, e - i - 30, 16, "#FFFFFF", "center"), L.render.textobjs[0].draw("h", l + 32, e - i - 30, 16, "#FFFFFF", "center"), L.render.textobjs[0].draw("t", l + 41, e - i - 30, 16, "#F5A8B4", "center"), L.render.textobjs[0].draw("s", l + 50, e - i - 30, 16, "#5BCEF5", "center")) : L.render.textobjs[0].draw(L.name, l, e - i - 30, 16, t, "center"), L.render.textobjs[1].draw(T.handleLargeNumber(L.score, 1), l, e - i - 16, 8, t, "center"), c.globalAlpha = 1
            }
        }

        function f() {
            S.animLoopHandle = window.requestAnimFrame(f), J.renderv += (J.view - J.renderv) / 30;
            let l = M.graphical.screenshotMode ? 2 : N();
            c.lineCap = "round", c.lineJoin = "round", c.filter = "none", S.gameStart && !S.disconnected && (S.time = X(), 1e3 < S.time - H && (S.socket.ping(S.time), H = S.time, R.rendertime = K, K = 0, R.updatetime = Y, Y = 0), R.lag = S.time - J.time), S.gameStart ? Ll(l) : !S.disconnected && al(), S.died && tl(), S.disconnected && nl()
        }
        let S = L(1),
            T = L(2),
            M = {
            ...
            I = {};
        T.pullJSON("color").then(function(l) {
            return I = l
        });
        let P = function() {
                let l = function(l) {
                ...
                return function(e, L, t = .5) {
                    ...
                    for (var a = "#", n = 1; 6 >= n; n += 2) {
                        for (var o = l(L.substr(n, 2)), r = l(e.substr(n, 2)), s = Math.floor(r + (o - r) * t).toString(16); 2 > s.length;) s = "0" + s;
                        a += s
                    }
                    return a
                }
        ...
        }(), S.statHover = 0, S.upgradeHover = 0;
        let A = [],
            _ = [],
            D = 0,
            B = [],
            ...
            W = {
                ...
                y: Math.sin(2 * Math.PI * Math.random())
            },
            U = [
                ["norm"]
            ],
        ...
        let O = function() {
            ...
            return {
                ...
                remove: function(l) {
                    return void 0 === L["_" + l] ? (logger.warn("Asked to removed an unknown leaderboard entry!"), -1) : void delete L["_" + l]
                },
                add: function(e) {
        ...
        window.onload = function() {
            ...
            let l = function(l) {
                ...
                if ("string" == typeof l) switch (l) {
                    ...
                    case "ExtraVM | Dallas (US) | 4TDM":
                        e = 2;
                        break;
                    case "ExtraVM | Dallas (US) | Developer Server":
                        e = 3;
                        break;
                ...
                switch (e) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        serverIP = "149.56.113.189", serverPort = 3002, serverName = "EVM-Ca :2TDM:", prefix = "-2tdm";
                        break;
                    case 5:
                        serverIP = "149.56.113.189", serverPort = 3001, serverName = "EVM-Ca :P-Dom:", prefix = "-pdom";
                        break;
                    case 6:
                        serverIP = "149.56.113.189", serverPort = 3006, serverName = "EVM-Ca :Ma-4TDM:", prefix = "-ma4tdm";
                        break;
                    case 7:
                        serverIP = "149.56.113.189", serverPort = 3007, serverName = "EVM-Ca :Mo-4TDM:", prefix = "-mo4tdm";
                        break;
                    default:
                        return logger.error("Failed to select a server because there was an invalid numeric input: " + l);
                }
                let L = ["ffa", "2dom", "4tdm", "dev", "2tdm", "pdom", "ma4tdm", "mo4tdm"];
                for (let t = 0; 8 > t; t++) document.getElementById(L[t]).style.color = e === t ? "#8ABC3F" : "#828282";
                logger.info("Server set to '" + serverName + "'."), localStorage.gamemode = serverName, T.pullJSON(`mockups${prefix}`).then(function(l) {
                    return C = l
                })
            };
            ...
            T.retrieveFromLocalStorage("playerNameInput"), T.retrieveFromLocalStorage("playerKeyInput"), T.retrieveFromLocalStorage("optScreenshotMode"), T.retrieveFromLocalStorage("optColors"), T.retrieveFromLocalStorage("optFancy"), T.retrieveFromLocalStorage("optNoPointy"), T.retrieveFromLocalStorage("optBorders"), T.retrieveFromLocalStorage("optFourRows"), T.retrieveFromLocalStorage("optMessages"), T.retrieveFromLocalStorage("optRoundUpg"), T.retrieveFromLocalStorage("optOldPredict"), "" === document.getElementById("optColors").value && (document.getElementById("optColors").value = "normal"), "" === document.getElementById("optBorders").value && (document.getElementById("optBorders").value = "normal"), document.getElementById("startButton").onclick = function() {
                m()
            }, document.onkeydown = function(l) {
                if (!(S.disconnected && S.gameStart)) {
                    let e = l.which || l.keyCode;
                    S.disableEnter || e !== S.KEY_ENTER || S.gameStart || m(), 0 >= S.diedAt + 3e3 - Date.now() && S.resetMenuColor && e === S.KEY_ENTER && setTimeout(function() {
                        S.tankMenuColor = 100 + Math.floor(72 * Math.random()), S.deathSplashChoice = Math.floor(Math.random() * S.deathSplash.length), S.closingSplashChoice = Math.floor(Math.random() * S.closingSplash.length)
                    }, 100)
                }
            }, window.addEventListener("resize", function() {
                J.screenWidth = G.width = S.screenWidth = window.innerWidth, J.screenHeight = G.height = S.screenHeight = window.innerHeight
            })
        };
        let V = L(3);
        window.canvas = new V;
        let G = window.canvas.cv,
            c = G.getContext("2d"),
        ...
        let w = [],
            ...
            j = function() {
                ...
                return {
                    ...
                    add: function(L) {
                        e.push(L), e.length > M.lag.memory && e.splice(0, 1)
                    }
                }
            }(),
            X = function() {
        ...
        let Q = function() {
                        ...
                        return {
                            ...
                            data: function() {
                                const e = function() {
                                    ...
                                    return function() {
                                        ...
                                        if (1 & o) a.facing = l.next(), a.layer = l.next();
                                            ...
                                            a.interval = R.rendergap, a.id = l.next();
                                            let e = A.findIndex(function(l) {
                                                return l.id === a.id
                                            });
                                            if (-1 !== e && (a = A.splice(e, 1)[0]), n = -1 === e, n || (a.render.draws = 1, a.render.lastx = a.x, a.render.lasty = a.y, a.render.lastvx = a.vx, a.render.lastvy = a.vy, a.render.lastf = a.facing, a.render.lastRender = J.time), a.index = l.next(), a.x = l.next(), a.y = l.next(), a.vx = l.next(), a.vy = l.next(), a.size = l.next(), a.facing = l.next(), a.vfacing = l.next(), a.twiggle = l.next(), a.layer = l.next(), a.color = l.next(), a.id === Z.playerid && (J.color = a.color), n) a.health = l.next() / 255, a.shield = l.next() / 255;
                                            else {
                                                let e = a.health,
                                                    L = a.shield;
                                            ...
                                            a.drawsHealth = !!(2 & o), a.invuln = 8 & o ? a.invuln || Date.now() : 0, a.alpha = l.next() / 255, a.cx = l.next(), a.cy = l.next(), a.seeInvisible = l.next(), a.nameColor = l.next(), 4 & o && (a.name = l.next(), a.score = l.next()), a.nameplate = 4 & o, n && (a.render = {
                                                ...
                                                x: a.x,
                                                y: a.y,
                                                lastx: a.x - R.rendergap * M.roomSpeed * (100 / 3) * a.vx,
                                                lasty: a.y - R.rendergap * M.roomSpeed * (100 / 3) * a.vy,
                                                lastvx: a.vx,
                                                lastvy: a.vy,
                                                lastf: a.facing,
                                                f: a.facing,
                                        ...
                                        for (let e = 0; e < r; e++) {
                                            let L = l.next(),
                                                t = l.next();
                                            L > J.lastUpdate - R.rendergap && a.guns.fire(e, t)
                                        }
                                        let s = l.next();
                                        if (n) {
                                            a.turrets = [];
                                ...
                                return function() {
                                    ...
                                    for (let l = 0, t; l < A.length; l++)
                                        if (t = A[l], t.render.status.set(1 === t.health ? "dying" : "killed"), 0 !== t.render.status.getFade() && d(t.render.x - J.renderx, t.render.y - J.rendery, t.size, 1)) L.push(t);
                                        else if (null != t.render.textobjs)
                                        for (let l of t.render.textobjs) l.remove();
                                    A = L, A.sort(function(l, e) {
                            ...
                            gui: function() {
                                ...
                                if (L.fps && (Z.fps = l.next()), L.label && (Z.type = l.next(), Z.color = l.next(), Z.playerid = l.next()), L.score && Z.skill.setScores(l.next()), L.points && (Z.points = l.next()), L.upgrades) {
                                    Z.upgrades = [];
                                    for (let e = 0, L = l.next(); e < L; e++) Z.upgrades.push(l.next())
                                }
                                if (L.statsdata)
                                    for (let e = 9; 0 <= e; e--) Z.skills[e].name = l.next(), Z.skills[e].cap = l.next(), Z.skills[e].softcap = l.next();
                                if (L.skills) {
                                    let e = parseInt(l.next(), 36).toString(16);
                                    e = "0000000000".substr(e.length) + e, Z.skills[0].amount = parseInt(e.slice(0, 1), 16), Z.skills[1].amount = parseInt(e.slice(1, 2), 16), Z.skills[2].amount = parseInt(e.slice(2, 3), 16), Z.skills[3].amount = parseInt(e.slice(3, 4), 16), Z.skills[4].amount = parseInt(e.slice(4, 5), 16), Z.skills[5].amount = parseInt(e.slice(5, 6), 16), Z.skills[6].amount = parseInt(e.slice(6, 7), 16), Z.skills[7].amount = parseInt(e.slice(7, 8), 16), Z.skills[8].amount = parseInt(e.slice(8, 9), 16), Z.skills[9].amount = parseInt(e.slice(9, 10), 16)
                                }
                                L.accel && (Z.accel = l.next()), L.topSpeed && (Z.topSpeed = l.next())
                            },
                            minimap: function() {
                                let e = function() {
                                    let L = function(l, e) {
                                    ...
                                    return function() {
                                        let e = l.next(),
                                            t = l.next() * S.gameWidth / 255,
                                            a = l.next() * S.gameHeight / 255,
                                            n = l.next();
                                        switch (e) {
                                            case -1: {
                                                let l = _.findIndex(function(l) {
                                                    return L(l, [t, a, n])
                                                }); - 1 === l ? logger.warn("Remove request for a minimap node we were not aware of!") : _.splice(l, 1)
                                            }
                                            break;
                                        case 1:
                                            _.push([t, a, n]);
                ...
                return function() {
                    let L = new WebSocket("ws://" + serverIP + ":" + serverPort);
                    return window.help = function() {
                        ...
                        e || (e = I.black), L.talk("D", 0, l, e), logger.info("Broadcasting your message to all players.")
                        ...
                        L.open = 1, S.message = "Please wait while a connection attempt is being made.", L.talk("k", S.playerKey), logger.info("Token submitted to the server for validation."), L.ping = function(l) {
                            L.talk("p", l)
                        ...
                        switch (a.splice(0, 1)[0]) {
                            case "w":
                                a[0] && (logger.info("The server has welcomed us to the game room! Sending spawn request."), L.talk("s", S.playerName, 1), S.message = "");
                                break;
                            case "R":
                                S.gameWidth = a[0], S.gameHeight = a[1], U = JSON.parse(a[2]), z = JSON.parse(a[3]), M.roomSpeed = a[4], logger.info("Room data recieved! Commencing syncing process."), L.talk("S", X());
                                break;
                            case "r":
                                S.gameWidth = a[0], S.gameHeight = a[1], U = JSON.parse(a[2]), logger.info("Room data reset!");
                                break;
                            case "c":
                                J.x = J.renderx = a[0], J.y = J.rendery = a[1], J.view = J.renderv = a[2], logger.info("Camera force moved!"), L.talk("M");
                                break;
                            case "S": {
                                S.deathSplashChoice = Math.floor(Math.random() * S.deathSplash.length), S.closingSplashChoice = Math.floor(Math.random() * S.closingSplash.length);
                                let l = a[0],
                                    e = a[1],
                                    t = (X() - l) / 2,
                                    n = X() - t - e;
                                if (w.push({
                                        delta: n,
                                        latency: t
                                    }), 10 > w.length) setTimeout(function() {
                                    L.talk("S", X())
                                }, 10), S.message = "Syncing clocks, please do not tab away! Progress: " + w.length + "/10...";
                                else {
                                    w.sort(function(l, e) {
                                        return l.latency - e.latency
                                    });
                                    let l = w[Math.floor(w.length / 2)].latency,
                                        L = 0,
                                        t = 0,
                                        a = 0;
                                    for (let e = 0; e < w.length; e++) L += Math.pow(w[e].latency - l, 2);
                                    L = Math.sqrt(L / w.length);
                                    for (let n = 0, o; n < w.length; n++) o = w[n], Math.abs(o.latency - l) < L && (t += o.delta, a++);
                                    x = Math.round(t / a), logger.norm(w), logger.info("Syncing complete! Calculated clock difference " + x + "ms. Beginning game."), S.message = "Finalizing...", setTimeout(() => {
                                        S.gameStart = !0, S.message = ""
                                    }, 1500)
                                }
                            }
                            break;
                        ...
                        case "u": {
                            let l = {
                                ...
                                t = a.slice(6);
                            l.time > J.lastUpdate ? (j.add(X() - l.time), J.time = l.time + j.get(), R.rendergap = l.time - J.lastUpdate, 0 >= R.rendergap && logger.warn("Yo some bullshit is up..."), J.lastUpdate = l.time, e.begin(t), e.gui(), e.data(), J.lastx = J.x, J.lasty = J.y, J.lastvx = J.vx, J.lastvy = J.vy, J.x = l.x, J.y = l.y, J.vx = S.died ? 0 : l.vx, J.vy = S.died ? 0 : l.vy, isNaN(J.renderx) && (J.renderx = J.x), isNaN(J.rendery) && (J.rendery = J.y), J.view = l.FoV, (isNaN(J.renderv) || 0 === J.renderv) && (J.renderv = 2e3), R.lastlag = R.lag, R.lastuplink = q()) : logger.info("This is old data! Last given time: " + J.time + "; offered packet timestamp: " + l.time + "."), L.cmd.talk(), Y++
                        }
                        break;
                        case "b":
                            ...
                            break;
                        case "p":
                            R.latency = S.time - a[0];
                            break;
                        case "F": {
                            S.finalScore = h(0, 4), S.finalScore.set(a[0]), S.finalLifetime = h(0, 5), S.finalLifetime.set(a[1]), S.finalKills = [h(0, 3), h(0, 4.5), h(0, 2.5)], S.finalKills[0].set(a[2]), S.finalKills[1].set(a[3]), S.finalKills[2].set(a[4]), S.finalKillers = [];
                            for (let l = 0; l < a[5]; l++) S.finalKillers.push(a[6 + l]);
                            S.died = S.resetMenuColor = !0, window.onbeforeunload = function() {
                                return 0
                            }, S.diedAt = S.playerKey.includes("_") ? 0 : Date.now()
                        }
                        break;
                        case "K":
                            ...
                            break;
                        case "P":
                            S.disconnectReason = a[0], "The arena has closed. Please try again later once the server restarts." === a[0] && (arenaClosed = !0);
                            break;
                        default:
                            throw new Error("Unknown message index!");
                        }
                    }, L.onclose = function() {
                        L.open = 0, S.disconnected = 1, clearInterval(L.commandCycle), window.onbeforeunload = function() {
                            return 0
                        }, logger.info("Socket closed."), S.message = S.disconnectReason
                    }, L.onerror = function(l) {
                        logger.error("Socket error: " + l + "."), S.message = "A socket error occurred. Maybe check your internet connection?"
                    }, L
                }
            }(),
            $ = function() {
                ...
                return function() {
                    ...
                    return {
                        draw: function(l, e, L, t, i) {
                            ...
                            if (t += M.graphical.fontSizeBoost, n[0].update(l), n[1].update(e), n[2].update(L), n[3].update(t), n[4].update(i), n[5].update(s), n.some(function(l) {
                                    return l.check()
                                })) {
                                let e = Math.max(3, t / 5),
                                    L = $(l, t - M.graphical.fontSizeBoost, 1);
                                a.canvas.height = L.height + 2 * e, a.canvas.width = L.width + 2 * e, "left" === s || "start" === s ? o = e : "center" === s ? o = a.canvas.width / 2 : "right" === s || "end" === s ? o = a.canvas.width - e : void 0, r = a.canvas.height / 2, a.lineWidth = e, a.font = "bold " + t + "px Ubuntu", a.textAlign = s, a.textBaseline = "middle", a.strokeStyle = I.black, a.fillStyle = i, a.lineCap = "round", a.lineJoin = "round", a.strokeText(l, o, r), a.fillText(l, o, r)
                            }
            ...
            el = function() {
                function l(l, e, L, t, a) {
                    ...
                    if (n += a % 2 ? 0 : Math.PI / a, l.beginPath(), !a) l.arc(e, L, t, 0, 2 * Math.PI);
                        ...
                        for (let o = 0; o < a; o++) {
                            ...
                            for (let [a, o] of [
                                    ...
                                    [1, 1.2 * Math.PI],
                                    [1, 1.6 * Math.PI]
                                ]) l.lineTo(e + t * a * Math.cos(n - .025 + o), L + t * a * Math.sin(n - .025 + o));
                        else if (103 === a)
                        for (let a = 0; 360 > a; a++) {
                        ...
                        for (let [a, o] of [
                                ...
                                [1, 1.429 * Math.PI],
                                [1, 1.714 * Math.PI]
                            ]) l.lineTo(e + t * a * Math.cos(n + o), L + t * a * Math.sin(n + o));
                    else if (108 === a)
                        for (let a = 0; 12 > a; a++) {
                            ...
                            for (let a = 0; 4 > a; a++) {
                                ...
                                for (let a = 0; 4 > a; a++) {
                                    ...
                                    for (let [a, o] of [
                                            ...
                                            [-1.16, 1.047],
                                            [-1, Math.PI / 2]
                                        ]) l.lineTo(e + t * a * Math.cos(n + (o - .025)), L + t * a * Math.sin(n + (o - .025)));
                                else if (113 === a)
                        for (let [a, o] of [
                                [1, .611],
                                [1, 1.571],
                        ...
                        for (let [a, o] of [
                                ...
                                [1.1, -.335],
                                [1.5, -.14]
                            ]) l.lineTo(e + t * (1.5 * a) * Math.cos(n + (o - .0261)), L + t * (1.5 * a) * Math.sin(n + (o - .0261)));
                    else if (117 === a)
                        for (let [a, o] of [
                                [1.95, 0],
                                [.95, .578],
                                ...
                                [-1, .82],
                                [.95, -.578]
                            ]) l.lineTo(e + t * (.9 * a) * Math.cos(n + o), L + t * (.9 * a) * Math.sin(n + o));
                    else if (118 === a)
                        for (let [a, o] of [
                                [.9, 0],
                                [.625, .698],
                                ...
                                [-.35, 1.361],
                                [.625, -.698]
                            ]) l.lineTo(e + t * a * Math.cos(n + (o - .0261)), L + t * a * Math.sin(n + (o - .0261)));
                    else if (119 === a)
                        for (let [a, o] of [
                                [1, 0],
                                [.75, .559],
                        ...
                        for (let [a, o] of [
                                ...
                                [1.315, -.331613],
                                [1, 0]
                            ]) l.lineTo(e + t * a * Math.cos(n + o + 1.5447), L + t * a * Math.sin(n + o + 1.5447));
                    else if (123 === a)
                        for (let [a, o] of [
                                [1, .541],
                                [-1, -.541],
                        ...
                        for (let a = 0; 4 > a; a++) {
                            ...
                            for (let [a, o] of [
                                    ...
                                    [1, 270],
                                    [1, 288]
                                ]) l.lineTo(e + t * a * Math.cos(o * Math.PI / 180 + n), L + t * a * Math.sin(o * Math.PI / 180 + n));
                        else if (143 === a)
                        for (let [a, o] of [
                                [1, 0],
                                [.905, 5],
                        ...
                        switch (l.save(), l.beginPath(), l.translate(e, L), l.rotate(n), a) {
                            ...
                            case 10001:
                                ...
                                break;
                            case 10002:
                                if (!M.graphical.fancyAnimations) break;
                                let i = new Image;
                ...
                function e(e, L, t, a, n, o, i, s) {
                    ...
                    e.lineJoin = M.graphical.pointy ? "miter" : "round", e.closePath(), e.stroke(), e.fill()
                }
                return function(L, a, n, s, d) {
                    let h = 5 < arguments.length && arguments[5] !== void 0 ? arguments[5] : 1,
                        ...
                        F = 9 < arguments.length && arguments[9] !== void 0 ? arguments[9] : 0,
                        v = 10 < arguments.length && arguments[10] !== void 0 ? arguments[10] : n.render,
                        w = y || c,
                        E = F ? 1 : v.status.getFade(),
                        b = (F ? 1 : v.status.getFade()) * d,
                        f = h * s * n.size,
                        x = C[n.index],
                        m = L,
                        T = a,
                        g = 0 === F ? n : F;
                    f *= 1 + (v.expandsWithDeath ? .5 : .2) * (1 - E);
                    try {
                        if (M.graphical.fancyAnimations && y !== k && 1 > b && 0 < b) w = k, w.canvas.width = w.canvas.height = f * x.position.axis + 7.5 * s * n.size, m = w.canvas.width / 2 - f * x.position.axis * x.position.middle.x * Math.cos(p) / 4, T = w.canvas.height / 2 - f * x.position.axis * x.position.middle.x * Math.sin(p) / 4;
                        else if (.1 >= E * b) return;
                        if (w.lineCap = "round", w.lineJoin = M.graphical.pointy ? "miter" : "round", g.turrets.length === x.turrets.length) {
                            for (let l = 0, e; l < x.turrets.length; l++)
                                if (e = x.turrets[l], 0 === e.layer) {
                                    let L = e.direction + e.angle + p,
                                        t = e.offset * f;
                                    el(m + t * Math.cos(L), T + t * Math.sin(L), e, s, 1, f / s / e.size * e.sizeFactor, g.turrets[l].facing + u * p, u, w, g.turrets[l], v)
                                }
                        } else throw new Error("Mismatch turret number with mockup!");
                        g.guns.update();
                        let d = v.status.getColor(),
                            h = v.status.getBlend(),
                            F = P(t(n.color), d, h),
                            S = n.invuln && 110 < (Date.now() - n.invuln) % 200;
                        if (S && (F = P(F, I.vlgrey, .5)), w.lineWidth = Math.max(M.graphical.mininumBorderChunk, s * M.graphical.borderChunk), g.guns.length === x.guns.length) {
                            let l = g.guns.getPositions();
                            for (let L = 0; L < x.guns.length; L++) {
                                let a = x.guns[L],
                                    ...
                                    g = P(t(a.color), d, h);
                                switch (S && (g = P(g, I.vlgrey, .5)), a.color_unmix) {
                                    case 0:
                                        o(w, g);
                                        break;
                                    case 1:
                                ...
                                e(w, m + f * s, T + f * c, f * (a.length / 2 - (1 === a.aspect ? 2 * n : 0)), f * a.width / 2, a.aspect, a.angle + p, a.skin)
                            }
                        } else throw new Error("Mismatch gun number with mockup!");
                        if (w.globalAlpha = 1, o(w, F), l(w, m, T, f / x.size * x.realSize, x.shape, p), g.turrets.length === x.turrets.length) {
                            for (let l = 0, e; l < x.turrets.length; l++)
                                if (e = x.turrets[l], 1 === e.layer) {
                                    let L = e.direction + e.angle + p,
                                        t = e.offset * f;
                                    el(m + t * Math.cos(L), T + t * Math.sin(L), e, s, 1, f / s / e.size * e.sizeFactor, g.turrets[l].facing + u * p, u, w, g.turrets[l], v)
                                }
                        } else throw new Error("Mismatch turret number with mockup!");
                        0 === y && w !== c && (c.save(), c.globalAlpha = b, c.drawImage(w.canvas, L - m, a - T), c.restore())
                    } catch (l) {
                        let e = ll();
                        e.draw("Loading entity mockups...", S.screenWidth / 2, S.screenHeight / 2, 30, I.lgreen, "center")
                    }
                }
            }();
        ...
        let Ll = function() {
                function l() {
                    ...
                    return function(e, L, t, a, n, o) {
                        ...
                        let r = Math.min.apply(Math, l),
                            ...
                            d = s - r;
                        0 < s && 0 > r && E(L, L + a, t + n * s / d, 2, I.guiwhite), c.beginPath();
                        let h = -1;
                ...
                let e = h(0, .7, 1.5),
                    ...
                    a = function() {
                        ...
                        let t = function(l, e) {
                                null == l && (l = !1), null == e && (e = R.rendergap);
                                let t = !1 === l ? q() - R.lastuplink : X() - l;
                                e = Math.max(e, 1e3 / M.roomSpeed / 30);
                                let a = t / e;
                                return {
                            ...
                            a = function(a, n) {
                                null == a && (a = J.time), null == n && (n = R.rendergap);
                                let o = 0,
                                    r = 0,
                                    i = 0;
                                return o = Math.max(X() - a - 80, -n), 150 < o && (o = 150), r = o / n, i = 30 * M.roomSpeed * o / 1e3, {
                        ...
                        return function(l, e) {
                            return M.lag.oldPrediction ? a(l, e) : t(l, e)
                        }
                    }(),
                    o = l(),
                    r = l(),
                    ...
                    m = function() {
                        ...
                        let e = [];
                        for (let L = 0; L < 2 * M.gui.expectedMaxSkillLevel; L++) e.push(l(L / M.gui.expectedMaxSkillLevel));
                        return function(l) {
                            return e[l]
                        }
                    }(),
                ...
                return function(h) {
                    ...
                    let w, z; {
                        ...
                        J.renderx = e, J.rendery = L, w = h * J.renderx, z = h * J.rendery
                    } {
                        g(I.white, 1), g(I.guiblack, .1);
                        let e = U[0].length,
                            L = U.length,
                            t = 0;
                        for (let l = 0; l < U.length; l++) {
                            ...
                            for (let r = 0; r < a.length; r++) {
                                let l = a[r],
                                    i = Math.max(0, h * o * S.gameWidth / e - w + S.screenWidth / 2),
                                    s = Math.max(0, h * t * S.gameHeight / L - z + S.screenHeight / 2),
                                    d = Math.min(S.screenWidth, h * (o + 1) * S.gameWidth / e - w + S.screenWidth / 2),
                                    m = Math.min(S.screenHeight, h * (t + 1) * S.gameHeight / L - z + S.screenHeight / 2);
                                c.globalAlpha = 1, c.fillStyle = M.graphical.screenshotMode ? I.guiwhite : I.white, c.fillRect(i, s, d - i, m - s), c.globalAlpha = .3, c.fillStyle = M.graphical.screenshotMode ? I.guiwhite : n(l, 1), c.fillRect(i, s, d - i, m - s), o++
                            }
                            t++
                        }
                        c.lineWidth = 1, c.strokeStyle = M.graphical.screenshotMode ? I.guiwhite : I.guiblack, c.globalAlpha = .04, c.beginPath();
                        let l = 30 * h;
                        for (let e = (S.screenWidth / 2 - w) % l; e < S.screenWidth; e += l) c.moveTo(e, 0), c.lineTo(e, S.screenHeight);
                        for (let e = (S.screenHeight / 2 - z) % l; e < S.screenHeight; e += l) c.moveTo(0, e), c.lineTo(S.screenWidth, e);
                        c.stroke(), c.globalAlpha = 1
                    }
                    J.cx = J.cy = null, A.forEach(function(l) {
                        ...
                        let e = l.id === Z.playerid;
                        !e || l.twiggle || S.died || (l.render.f = Math.atan2(W.y, W.x));
                        let L = h * l.render.x - w,
                            t = h * l.render.y - z;
                        L += S.screenWidth / 2, t += S.screenHeight / 2, e && (J.canSeeInvisible = l.seeInvisible, J.cx = L, J.cy = t), el(L, t, l, h, !e && J.canSeeInvisible ? l.alpha + .5 : l.alpha, 1.1, l.render.f)
                    }), M.graphical.screenshotMode || A.forEach(function(l) {
                        let e = h * l.render.x - w,
                            L = h * l.render.y - z;
                        e += S.screenWidth / 2, L += S.screenHeight / 2, b(e, L, l, h, J.canSeeInvisible ? l.alpha + .5 : l.alpha)
                    });
                    do {
                        if (!S.showTree) break;
                        S.died && (S.showTree = !1, S.scrollX = 0);
                        let l = C.find(l => l.name === S.searchName);
                        if (!l) break;
                        c.globalAlpha = 1;
                        let e = [],
                            L = [],
                            a = (l, t, n, {
                                ...
                                switch (r) {
                                    ...
                                    case 0: {
                                        ...
                                        return {
                                            width: n.map(l => l.width).reduce((l, e) => l + e, 0),
                            ...
                            o = "Basic" === S.searchName ? .8 : 1.25,
                            r = Math.min(55 * (.9 * S.screenWidth / n.width), .9 * S.screenHeight / n.height) / o,
                            i = r - 4;
                        for (let [l, e] of L) {
                            let L = S.screenWidth / 2 + (l.x - n.width * S.scrollX) * r + 1 + .5 * i,
                                t = S.screenHeight / 2 + (l.y - n.height / 2) * r + 1 + .5 * i,
                                a = S.screenWidth / 2 + (e.x - n.width * S.scrollX) * r + 1 + .5 * i,
                                o = S.screenHeight / 2 + (e.y - n.height / 2) * r + 1 + .5 * i;
                            c.strokeStyle = I.black, c.lineWidth = 2, v(L, t + 60, a, o + 60)
                        }
                        for (let {
                                x: l,
                                y: L,
                            ...
                            let e = S.screenWidth / 2 + (l - n.width * S.scrollX) * r,
                                i = S.screenHeight / 2 + (L - n.height / 2) * r + 60,
                                d = r;
                            if (a = S.tankMenuColor, -30 > e || e + d - 30 > S.screenWidth) continue;
                            c.globalAlpha = .75, c.fillStyle = t(185 < a ? a - 85 : a), p(e, i, d, d), c.globalAlpha = .15, c.fillStyle = t(-10 + (a++ - (185 < a ? 85 : 0))), p(e, i, d, .6 * d), c.fillStyle = I.black, p(e, i + .6 * d, d, .4 * d), c.globalAlpha = 1;
                            let h = -Math.PI / 4,
                                m = s(o, Z.color),
                                g = C[o].position,
                                u = .8 * d / g.axis,
                                y = e + .5 * d - u * g.middle.x * Math.cos(h),
                                F = i + .5 * d - u * g.middle.x * Math.sin(h);
                            el(y, F, m, .5, 1, 2 * (u / m.size), h, !0), c.strokeStyle = I.black, c.globalAlpha = 1, c.lineWidth = 2, p(e, i, d, d, !0)
                        }
                    } while (!1);
                    let l = 200 / Math.max(S.screenWidth, 16 * S.screenHeight / 9);
                    Z.skill.update();
                    let H = O.get(),
                        Y = H.max;
                    if (!M.graphical.disableMessages) {
                        let l = S.screenWidth / 2,
                            e = 20,
                            L;
                        for (let t = B.length - 1; 0 <= t; t--) {
                            let a = B[t],
                                n = a.text,
                                o = n;
                            if (null == a.textobj && (a.textobj = ll()), null == a.len && (a.len = $(o, 14)), c.globalAlpha = .5 * a.alpha, L = "rainbow" === a.color ? HSL2COLOR(`hsl(${Date.now()%2520/7}, 100%, 50%)`) : a.color, E(l - a.len / 2, l + a.len / 2, e + 9, 18, L), c.globalAlpha = Math.min(1, a.alpha), a.textobj.draw(o, l, e + 9, 14, I.guiwhite, "center", 1), e += 22, 1 < a.status && (e -= 22 * (1 - Math.sqrt(a.alpha))), 1 < a.status) a.status -= .05, a.alpha += .05;
                            else if (0 === t && (6 < B.length || 1e4 < Date.now() - a.time)) {
                                let l = 15 < B.length ? 5 : 1;
                                a.status -= .05 * l, a.alpha -= .05 * l, (0 >= a.alpha || 40 < B.length) && (B[0].textobj.remove(), B.splice(0, 1))
                            }
                        }
                        c.globalAlpha = 1
                    } {
                        S.canSkill = !!Z.points, e.set(0 + (S.canSkill || S.died || S.statHover)), S.clickables.stat.hide();
                        let L = 15,
                            t = 35,
                            a = l * S.screenWidth,
                            n = a,
                            o = -20 - 2 * a + e.get() * (40 + 2 * a),
                            r = S.screenHeight - 20 - 15,
                            i = 11,
                            s = Z.getStatNames(C[Z.type].statnames || -1);
                        Z.skills.forEach(function(l) {
                            i--;
                            let e = s[i - 1],
                                d = l.amount,
                                h = I[l.color],
                            ...
                            if (g) {
                                a = n;
                                let l = M.gui.expectedMaxSkillLevel,
                                    s = g > l;
                                if (s && (l = g), E(o + L / 2, o - L / 2 + a * m(g), r + L / 2, 12 + M.graphical.barChunk, I.black), E(o + L / 2, o + L / 2 + (a - t) * m(g), r + L / 2, 12, I.grey), E(o + L / 2, o + L / 2 + (a - t) * m(d), r + L / 2, L - 3.5, h), g < p) {
                                    c.lineWidth = 1, c.strokeStyle = I.grey;
                                    for (let e = g + 1; e < l; e++) v(o + (a - t) * m(e), r + 1.5, o + (a - t) * m(e), r - 3 + L)
                                }
                                c.strokeStyle = I.black, c.lineWidth = 1;
                                for (let l = 1; l < d + 1; l++) v(o + (a - t) * m(l), r + 1.5, o + (a - t) * m(l), r - 3 + L);
                                a = n * m(l);
                                let u = d == p ? h : Z.points && (g === p || d != g) ? I.guiwhite : I.grey;
                                f.skillNames[i - 1].draw(e, Math.round(o + a / 2) + .5, r + L / 2, 10, u, "center", 1), f.skillKeys[i - 1].draw("[" + i % 10 + "]", Math.round(o + a - .25 * L) - 1.5, r + L / 2, 10, u, "right", 1), u === I.guiwhite && S.clickables.stat.place(i - 1, o, r, a, L), d && f.skillValues[i - 1].draw(u === h ? "MAX" : "+" + d, Math.round(o + a + 4) + .5, r + L / 2, 10, h, "left", 1), r -= 19
                            }
                        }), S.clickables.hover.place(0, 0, r, .8 * a, .8 * (S.screenHeight - r)), 0 !== Z.points && f.skillPoints.draw("x" + Z.points, Math.round(o + a - 2) + .5, Math.round(r + 15 - 4) + .5, 20, I.guiwhite, "right")
                    } {
                        let e = 1.65 * l * S.screenWidth,
                            L = 25,
                            t = (S.screenWidth - e) / 2,
                            a = S.screenHeight - 20 - L;
                        c.lineWidth = 1, E(t, t + e, a + L / 2, L - 3 + M.graphical.barChunk, I.black), E(t, t + e, a + L / 2, L - 3, I.grey), E(t, t + e * Z.skill.getProgress(), a + L / 2, L - 3.5, I.gold), f.class.draw("Level " + Z.skill.getLevel() + " " + C[Z.type].name, t + e / 2, a + L / 2, L - 4, I.guiwhite, "center", 1), L = 14, a -= L + 4, E(t + .1 * e, t + .9 * e, a + L / 2, L - 3 + M.graphical.barChunk, I.black), E(t + .1 * e, t + .9 * e, a + L / 2, L - 3, I.grey), E(t + .1 * e, t + e * (.1 + .8 * (Y ? Math.min(1, Z.skill.getScore() / Y) : 1)), a + L / 2, L - 3.5, I.green), f.score.draw("Score: " + T.formatLargeNumber(Math.round(Z.skill.getScore())), t + e / 2, a + L / 2, L - 2, I.guiwhite, "center", 1), c.lineWidth = 4, f.name.draw(J.name, Math.round(t + e / 2) + .5, Math.round(a - 10 - 4) + .5, 32, J.nameColor, "center")
                    } {
                        let e = l * S.screenWidth,
                            L = e,
                            a = S.screenWidth - e - 20,
                            s = S.screenHeight - L - 20,
                            m = 66,
                            g = U[0].length,
                            u = U.length,
                            h = 0;
                        ...
                        c.fillStyle = I.grey, p(a, s, e, L);
                        for (let l = 0, n; l < _.length; l++)
                            if (n = _[l], 17 === n[2]) c.fillStyle = P(t(n[2]), I.black, .5), c.globalAlpha = .8, p(a + n[0] / S.gameWidth * e, s + n[1] / S.gameHeight * L, 1, 1);
                            else if (16 === n[2] || 18 === n[2]) {
                            c.strokeStyle = I.black, c.lineWidth = 1, c.fillStyle = P(t(16), I.black, .5), c.globalAlpha = .8;
                            let l = 16 === n[2] ? 4 : 1,
                                o = a + n[0] / S.gameWidth * e - l,
                                r = s + n[1] / S.gameHeight * L - l;
                            16 === n[2] ? p(o, r, 6.75, 6.75) : F(o, r, 2)
                        } else c.strokeStyle = P(t(n[2]), I.black, .5), c.lineWidth = 1, c.globalAlpha = 1, p(a + n[0] / S.gameWidth * e - 1, s + n[1] / S.gameWidth * L - 1, 3, 3, 1), c.lineWidth = 3;
                        c.globalAlpha = 1, c.lineWidth = 1, c.strokeStyle = I.black, c.fillStyle = t(J.color), S.died || F(a + J.x / S.gameWidth * e - 1, s + J.y / S.gameWidth * L - 1, 2), c.lineWidth = 4, c.fillStyle = I.black, p(a, s, e, L, 1), S.debug && !S.died && (p(a, s - 40, e, 30), r(j.get(), a, s - 40, e, 30, I.teal), d(R.rendergap, a, s - 40, e, 30, I.pink), o(k, a, s - 40, e, 30, I.yellow), s -= 40), S.debug && !S.died && (m = 94, f.debug[4].draw("Prediction: " + Math.round(k) + "ms", a + e, s - 78, 10, I.guiwhite, "right"), f.debug[3].draw("Update Rate: " + R.updatetime + "Hz", a + e, s - 64, 10, I.guiwhite, "right")), f.debug[5].draw("Woomy-Arras.io", a + e, s - m, 13, "#B6E57C", "right"), f.debug[2].draw("Client FPS: " + R.rendertime, a + e, s - 50, 10, 15 < R.rendertime ? I.guiwhite : I.orange, "right"), f.debug[1].draw((S.died ? "Server Speed (Standby): " : "Server Speed: ") + (100 * Z.fps).toFixed(2) + "%", a + e, s - 22, 10, 1 === Z.fps ? I.guiwhite : I.orange, "right"), f.debug[3].draw("Latency: " + R.latency + "ms", a + e, s - 36, 10, 200 > R.latency ? I.guiwhite : I.orange, "right"), f.debug[0].draw(serverName, a + e, s - 8, 10, I.guiwhite, "right")
                    } {
                        let e = l * S.screenWidth,
                            L = 14,
                            t = S.screenWidth - e - 20,
                            a = 41;
                        f.lbtitle.draw("Leaderboard:", Math.round(t + e / 2) + .5, Math.round(a - 6) + .5, 18, I.guiwhite, "center");
                        let n = 0;
                        for (let l = 0, o; l < H.data.length; l++) {
                            o = H.data[l], E(t, t + e, a + 7, 11 + M.graphical.barChunk, I.black), E(t, t + e, a + 7, 11, I.grey);
                            let r = Math.min(1, o.score / Y);
                            E(t, t + e * r, a + 7, L - 3.5, o.barcolor), f.leaderboard[n++].draw(o.label + ": " + T.handleLargeNumber(Math.round(o.score)), t + e / 2, a + 7, 9, o.nameColor, "center", 1);
                        ...
                        L.set(0 + (S.canUpgrade || S.upgradeHover));
                        let e = L.get();
                        if (S.clickables.upgrade.hide(), 0 < Z.upgrades.length) {
                            S.canUpgrade = 1;
                            let L = 10,
                                a = 20 * (2 * e) - 20,
                                n = S.tankMenuColor,
                                ...
                                h = r,
                                g = 0,
                                y = l * S.screenWidth / 2.05,
                                F = y;
                            D += .01;
                            for (let l of Z.upgrades) {
                                if (r > h && (h = r - 60), d = 2 * a + 105, S.clickables.upgrade.place(o++, r, a, y, F), c.globalAlpha = .5, c.fillStyle = t(185 < n ? n - 85 : n), M.graphical.roundUpgrades ? u(r, a, y, F, 10) : p(r, a, y, F), c.globalAlpha = .175, c.fillStyle = t(-10 + (n++ - (185 < n ? 85 : 0))), M.graphical.roundUpgrades ? u(r, a, y, .6 * F, 4) : p(r, a, y, .6 * F), c.fillStyle = I.black, M.graphical.roundUpgrades ? u(r, a + .6 * F, y, .4 * F, 4) : p(r, a + .6 * F, y, .4 * F), !S.died && !S.disconnected) {
                                    let l = Math.pow(S.target.x + S.screenWidth / 2 - (r + F / 2), 2),
                                        e = Math.pow(S.target.y + S.screenHeight / 2 - (a + y / 2), 2);
                                    Math.sqrt(l + e) < .55 * F && (M.graphical.roundUpgrades ? u(r, a, y, F, 10) : p(r, a, y, F), c.globalAlpha = .5)
                                }
                                c.globalAlpha = 1;
                                let m = s(l, Z.color),
                                    v = C[l].position,
                                    k = .6 * y / v.axis,
                                    w = r + .5 * F - k * v.middle.x * Math.cos(D),
                                    E = a + .5 * y - k * v.middle.x * Math.sin(D);
                                el(w, E, m, 1, 1, k / m.size, D, 1), f.upgradeNames[o - 1].draw(m.name, r + y / 2, a + F - 6, F / 8 - 3, I.guiwhite, "center"), c.strokeStyle = I.black, c.globalAlpha = 1, c.lineWidth = 3, M.graphical.roundUpgrades ? u(r, a, y, F, 10, !1, !0) : p(r, a, y, F, !0), 0 == ++g % (M.graphical.useFourRows ? 4 : 3) ? (a = i, r += F + L) : a += e * (y + L)
                            }
                            let v = $("Ignore", 11) + 10,
                                m = h + F + 10,
                                k = (d + y + 10 + i - 15) / 2;
                            E(m - v / 2, m + v / 2, k + 7, 14 + M.graphical.barChunk, I.black), E(m - v / 2, m + v / 2, k + 7, 14, I.white), f.skipUpgrades.draw("Ignore", m, k + 7, 12, I.guiwhite, "center", 1), S.clickables.skipUpgrades.place(0, m - v / 2, k, v, 14)
                        } else S.canUpgrade = 0, S.clickables.upgrade.hide(), S.clickables.skipUpgrades.hide()
                    }
                    R.lastrender = X()
                }
            }(),
            tl = function() {
                let l = {
                    ...
                    e = function() {
                        let l = [Math.round(S.finalKills[0].get()), Math.round(S.finalKills[1].get()), Math.round(S.finalKills[2].get())],
                            e = l[0] + .5 * l[1] + 3 * l[2];
                    ...
                    L = function() {
                        let l = "";
                        if (S.finalKillers.length) {
                            l = "\uD83D\uDD2A Succumbed to";
                            for (let e = 0; e < S.finalKillers.length; e++) l += " " + T.addArticle(C[S.finalKillers[e]].name) + " and";
                            l = l.slice(0, -4) + "."
                ...
                return function() {
                    g(I.black, .25);
                    let t = S.screenWidth / 2,
                        a = S.screenHeight / 2 - 50,
                        n = s(Z.type, Z.color),
                        o = C[Z.type].position,
                        r = 140 / o.axis,
                        i = S.screenWidth / 2 - .707 * (r * o.middle.x),
                        d = S.screenHeight / 2 - 35 + .707 * (r * o.middle.x),
                        c = Math.ceil((S.diedAt + 3e3 - Date.now()) / 1e3);
                    el(i - 190 - 70, d - 10, n, 1.5, 1, .5 * r / n.realSize, -Math.PI / 4, 1), l.taunt.draw(S.deathSplash[S.deathSplashChoice], t, a - 80, 8, I.guiwhite, "center"), l.level.draw("Level " + Z.skill.getLevel() + " " + C[Z.type].name, t - 170, a - 30, 24, I.guiwhite), l.score.draw("Final Score: " + T.formatLargeNumber(Math.round(S.finalScore.get())), t - 170, a + 25, 50, I.guiwhite), l.time.draw("\u231A Survived for " + T.formatTime(Math.round(S.finalLifetime.get())) + ".", t - 170, a + 55, 16, I.guiwhite), l.kills.draw(e(), t - 170, a + 77, 16, I.guiwhite), l.death.draw(L(), t - 170, a + 99, 16, I.guiwhite), l.playagain.draw(0 < c ? "You may respawn in " + c + " second" + (1 === c ? "" : "s") + "." : "Press enter to respawn!", t, a + 125, 16, I.guiwhite, "center")
                }
            }(),
            al = function() {
                let l = {
                    ...
                    e = S.tipSplash[Math.floor(Math.random() * S.tipSplash.length)];
                return function() {
                    g(I.white, .5), l.connecting.draw("Connecting...", S.screenWidth / 2, S.screenHeight / 2, 30, I.guiwhite, "center"), l.message.draw(S.message, S.screenWidth / 2, S.screenHeight / 2 + 30, 15, I.lgreen, "center"), l.message.draw(e, S.screenWidth / 2, S.screenHeight / 2 + 75, 15, I.guiwhite, "center")
                }
            }(),
            nl = function() {
                let l = {
                ...
                return function() {
                    let e = arenaClosed ? I.yellow : I.red,
                        L = S.died ? 120 : 0;
                    g(P(e, I.guiblack, .3), .25), l.disconnected.draw("\uD83D\uDC80 Disconnected \uD83D\uDC80", S.screenWidth / 2, S.screenHeight / 2 + L, 30, I.guiwhite, "center"), l.message.draw(S.message, S.screenWidth / 2, S.screenHeight / 2 + 30 + L, 15, e, "center"), arenaClosed && l.message.draw(S.closingSplash[S.closingSplashChoice], S.screenWidth / 2, S.screenHeight / 2 + 45 + L, 15, e, "center")
                }
            }()
    }, function(l) {
        "use strict";
        ...
        e.submitToLocalStorage = function(l) {
            return localStorage.setItem(l + "Value", document.getElementById(l).value), localStorage.setItem(l + "Checked", document.getElementById(l).checked), 0
        }, e.retrieveFromLocalStorage = function(l) {
            return document.getElementById(l).value = localStorage.getItem(l + "Value"), document.getElementById(l).checked = "true" === localStorage.getItem(l + "Checked"), 0
        }, e.handleLargeNumber = function(l) {
            let e = 1 < arguments.length && arguments[1] !== void 0 ? arguments[1] : 0;
            return e && 0 == l ? "" : l < Math.pow(10, 3) ? "" + l.toFixed(0) : l < Math.pow(10, 6) ? (l / Math.pow(10, 3)).toFixed(2) + "k" : l < Math.pow(10, 9) ? (l / Math.pow(10, 6)).toFixed(2) + "m" : l < Math.pow(10, 12) ? (l / Math.pow(10, 9)).toFixed(2) + "b" : l < Math.pow(10, 15) ? (l / Math.pow(10, 12)).toFixed(2) + "t" : l < Math.pow(10, 18) ? (l / Math.pow(10, 15)).toFixed(2) + "qd" : l < Math.pow(10, 21) ? (l / Math.pow(10, 18)).toFixed(2) + "qt" : l < Math.pow(10, 24) ? (l / Math.pow(10, 21)).toFixed(2) + "sx" : l < Math.pow(10, 27) ? (l / Math.pow(10, 24)).toFixed(2) + "sp" : l < Math.pow(10, 30) ? (l / Math.pow(10, 27)).toFixed(2) + "o" : l < Math.pow(10, 33) ? (l / Math.pow(10, 30)).toFixed(2) + "n" : 1e38 < l ? "Infinity" : isNaN(l) ? "NaN" : (l / Math.pow(10, 33)).toFixed(2) + "d"
            ...
            let e = new XMLHttpRequest,
                L = "http://" + serverIP + "/json/" + l + ".json?a=" + Date.now();
        ...
        let t = L(1),
            a = function() {
                ...
                return _createClass(l, [{
                    ...
                    key: "gameInput",
                    value: function(l) {
                        null != t.player.cx && null != t.player.cy && (this.parent.target.x = l.clientX - t.player.cx, this.parent.target.y = l.clientY - t.player.cy), this.parent.target.x || (this.parent.target.x = .5), this.parent.target.y || (this.parent.target.y = .5), t.target = this.parent.target, t.statHover = 0 === t.clickables.hover.check({
                            x: l.clientX,
                            y: l.clientY
                        })
                    }
